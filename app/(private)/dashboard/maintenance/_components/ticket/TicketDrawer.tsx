...
export function TicketDrawer({
  ...
  return (
    <Drawer
      ...
      title={isEdit ? "Edit Ticket" : "Tambah Ticket"}
      ...
      <div className="flex flex-col h-full">
        <div className="flex-1 overflow-y-auto space-y-4 pb-2">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="drawer-venue">Venue *</Label>
            <Select value={form.venueId} onValueChange={(v) => set("venueId", v)}>
              <SelectTrigger id="drawer-venue" className="w-full">
          ...
          {/* Priority */}
          <div className="space-y-1.5">
            <Label htmlFor="drawer-priority">Prioritas *</Label>
          ...
          {/* Assigned To */}
          <div className="space-y-1.5">
            <Label htmlFor="drawer-assigned">Assign To</Label>
            <Select
              value={form.assignedToId || "none"}
              onValueChange={(v) => set("assignedToId", v === "none" ? "" : v)}
            >
              <SelectTrigger id="drawer-assigned" className="w-full">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="drawer-vendor" className="cursor-pointer">
                Vendor
              </Label>
            </div>
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="drawer-audit" className="cursor-pointer">
                Audit
              </Label>
            </div>
          </div>
          ...
          {/* Description */}
          <div className="space-y-1.5">
            <Label htmlFor="drawer-description">Deskripsi *</Label>
            <Textarea
