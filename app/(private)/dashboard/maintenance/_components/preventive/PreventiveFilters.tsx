    ...
    <div className="flex flex-col gap-3 px-4 sm:px-6 py-4 border-b">
      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-2">
          <Checkbox
            id="prev-filter-vendor"
            checked={isVendor}
            onCheckedChange={(checked) => onIsVendorChange(checked === true)}
          />
          <Label htmlFor="prev-filter-vendor" className="text-sm cursor-pointer">
            Vendor
          </Label>
        </div>
        <div className="flex items-center gap-2">
          <Checkbox
            id="prev-filter-audit"
            checked={isAudit}
            onCheckedChange={(checked) => onIsAuditChange(checked === true)}
          />
          <Label htmlFor="prev-filter-audit" className="text-sm cursor-pointer">
            Audit
          </Label>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:flex-wrap">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="relative">
            ...
            <Input
              type="search"
              aria-label="Cari jadwal preventive"
