...
const GROUPS: SettingGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Route,
        href: "/general/settings/approval-flow",
        module: "settings-role-permission",
      },
      {
        title: "Customers",
        ...
        icon: UserRounded,
        href: "/general/settings/customer",
        module: "customers",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: CardIcon,
        href: "/general/settings/payment-methods",
      ...
      },
      {
        ...
        icon: Document,
        href: "/general/settings/quotation-templates",
      ...
      },
      {
        ...
        icon: Book,
        href: "/general/settings/tutorial",
      ...
      },
      {
        ...
        icon: InfoCircle,
        href: "/general/settings/source-of-information",
      ...
      },
      {
        ...
        icon: Buildings2,
        href: "/general/settings/daily-activity-segment",
      ...
      },
      {
        ...
        icon: Diploma,
        href: "/general/settings/education-level",
      ...
      },
      {
        ...
        icon: List,
        href: "/general/settings/order-status",
      ...
      },
      {
        ...
        icon: CalendarMark,
        href: "/general/settings/event-types",
    ...
    items: [
      {
        ...
        icon: Sledgehammer,
        href: "/general/settings/maintenance-category",
      ...
      },
      {
        ...
        icon: Sledgehammer,
        href: "/general/settings/maintenance-priority",
      ...
      },
      {
        ...
        icon: Sledgehammer,
        href: "/general/settings/maintenance-status",
