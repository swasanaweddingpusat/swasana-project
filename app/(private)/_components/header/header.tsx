...
import { Book, CalendarAdd, Buildings, DocumentAdd, AltArrowDown, BoxMinimalistic, BellBing, Wallet2, Notebook } from "@solar-icons/react";
...
export function Header() {
  ...
  const hasAnyCreatePermission = canCreateWedding || canCreateMice || canCreateQuotation || canCreateProcurement || canCreateGuestbook;
