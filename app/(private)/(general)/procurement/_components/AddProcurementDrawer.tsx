    ...
    >
      ...
      >
        <div className="flex-1 overflow-y-auto pb-2">
          ...
          <fieldset className="space-y-4 pb-5">
            <legend className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">Info Dasar</legend>
          ...
          <fieldset className="space-y-4 py-5">
            <legend className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">Kuantitas & Harga</legend>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                ...
                />
                <p className="text-[10px] text-muted-foreground">Auto: total x harga</p>
              </div>
            </div>
          ...
          <fieldset className="space-y-4 py-5">
            <legend className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">Detail Acara</legend>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  placeholder="Catatan non-wedding"
                  className="rounded-xl"
          ...
          <fieldset className="space-y-4 pt-5 pb-2">
            <legend className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">Informasi Tambahan</legend>
            ...
            <div className="space-y-1.5">
              ...
              {(buktiBelUrl ?? uploadFile) ? (
                ...
                <button
                  ...
                  className="w-full flex flex-col items-center justify-center gap-1.5 rounded-xl border-2 border-dashed border-muted-foreground/25 hover:border-primary/50 hover:bg-primary/5 p-5 transition-colors cursor-pointer"
                >
                  <UploadMinimalistic weight="BoldDuotone" className="h-6 w-6 text-muted-foreground" />
                  <span className="text-xs text-muted-foreground">
                    Klik untuk upload bukti beli (gambar/PDF)
                  </span>
                </button>
              )}
              <input
