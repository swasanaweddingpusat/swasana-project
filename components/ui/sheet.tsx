        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className={cn('absolute', 'top-3', 'right-3', 'text-destructive', 'hover:text-destructive')}
                size="icon-sm"
              />
            }
          >
