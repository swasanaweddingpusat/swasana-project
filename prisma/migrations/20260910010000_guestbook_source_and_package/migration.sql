...
ALTER TABLE "guestbook_entries" DROP CONSTRAINT IF EXISTS "guestbook_entries_sourceOfInformationId_fkey";
...
ALTER TABLE "guestbook_entries" DROP CONSTRAINT IF EXISTS "guestbook_entries_packageId_fkey";
